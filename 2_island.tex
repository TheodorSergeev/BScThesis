...
\begin{figure}[!htb]
    ...
    \begin{minipage}[b]{.3\textwidth}
        \centering
        \includegraphics[trim={665px 65px 585px 65px},clip,width=1.00\textwidth]{images/gas_field/0.05.png}
    \end{minipage}
    \begin{minipage}[b]{.3\textwidth}
        \centering
        \includegraphics[trim={665px 65px 585px 65px},clip,width=1.00\textwidth]{images/gas_field/0.20.png}
    \end{minipage}
    \begin{minipage}[b]{.3\textwidth}
        \centering
        \includegraphics[trim={580px 65px 500px 65px},clip,width=1.00\textwidth]{images/gas_field/0.40.png}
    \end{minipage}\\
    \begin{minipage}[b]{.3\textwidth}
        \centering
        \includegraphics[trim={580px 65px 500px 65px},clip,width=1.00\textwidth]{images/gas_field/0.50.png}
    \end{minipage}
    \begin{minipage}[b]{.3\textwidth}
        \centering
        \includegraphics[trim={580px 65px 500px 65px},clip,width=1.00\textwidth]{images/gas_field/0.565.png}
    \end{minipage}
    \begin{minipage}[b]{.3\textwidth}
        \centering
        \includegraphics[trim={580px 65px 500px 65px},clip,width=1.00\textwidth]{images/gas_field/0.595.png}
    \end{minipage}
...
Эта задача была решена с помощью схемы Куранта-Изаксона-Риса первого порядка \eqref{eq:cir_scheme} на регулярных прямоугольных сетках с шагом 0.5 \texttimes 0.5 м., шагом по времени 0.02 мс.
...
Рассмотрим теперь распределения давления $p$ (\autoref{fig:stamp_p}), напряжения фон Мизеса (\autoref{fig:stamp_mises}).
